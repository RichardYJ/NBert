...
'''
    ...
    def initEventMethods(self):
        self.EventMethods = {
            self.QSFP1_AR1_LS_label.setText,
            self.QSFP1_AR1_EM_label.setText,
            self.QSFP1_AR1_BR_label.setText,
            self.QSFP1_AR1_PF_label.setText,
            self.QSFP1_AR2_LS_label.setText,
            self.QSFP1_AR2_EM_label.setText,
            self.QSFP1_AR2_BR_label.setText,
            self.QSFP1_AR2_PF_label.setText,
            self.QSFP1_AR3_LS_label.setText,
            self.QSFP1_AR3_EM_label.setText,
            self.QSFP1_AR3_BR_label.setText,
            self.QSFP1_AR3_PF_label.setText,
            self.QSFP1_AR4_LS_label.setText,
            self.QSFP1_AR4_EM_label.setText,
            self.QSFP1_AR4_BR_label.setText,
            self.QSFP1_AR4_PF_label.setText,

            self.QSFP2_AR1_LS_label.setText,
            self.QSFP2_AR1_EM_label.setText,
            self.QSFP2_AR1_BR_label.setText,
            self.QSFP2_AR1_PF_label.setText,
            self.QSFP2_AR2_LS_label.setText,
            self.QSFP2_AR2_EM_label.setText,
            self.QSFP2_AR2_BR_label.setText,
            self.QSFP2_AR2_PF_label.setText,
            self.QSFP2_AR3_LS_label.setText,
            self.QSFP2_AR3_EM_label.setText,
            self.QSFP2_AR3_BR_label.setText,
            self.QSFP2_AR3_PF_label.setText,
            self.QSFP2_AR4_LS_label.setText,
            self.QSFP2_AR4_EM_label.setText,
            self.QSFP2_AR4_BR_label.setText,
            self.QSFP2_AR4_PF_label.setText,

            self.SFP1_AR_LS_label.setText,
            self.SFP1_AR_EM_label.setText,
            self.SFP1_AR_BR_label.setText,
            self.SFP1_AR_PF_label.setText,
            self.SFP2_AR_LS_label.setText,
            self.SFP2_AR_EM_label.setText,
            self.SFP2_AR_BR_label.setText,
            self.SFP2_AR_PF_label.setText,
            self.SFP3_AR_LS_label.setText,
            self.SFP3_AR_EM_label.setText,
            self.SFP3_AR_BR_label.setText,
            self.SFP3_AR_PF_label.setText,
            self.SFP4_AR_LS_label.setText,
            self.SFP4_AR_EM_label.setText,
            self.SFP4_AR_BR_label.setText,
            self.SFP4_AR_PF_label.setText
        }
