...
###########################
           "49":self.QSFP1_AR1_LS_label.setStyleSheet,
           "50":self.QSFP1_AR2_LS_label.setStyleSheet,
           "51":self.QSFP1_AR3_LS_label.setStyleSheet,
           "52":self.QSFP1_AR4_LS_label.setStyleSheet,
           "53":self.QSFP2_AR1_LS_label.setStyleSheet,
           "54":self.QSFP2_AR2_LS_label.setStyleSheet,
           "55":self.QSFP2_AR3_LS_label.setStyleSheet,
           "56":self.QSFP2_AR4_LS_label.setStyleSheet,           	
           "57":self.SFP1_AR_LS_label.setStyleSheet,
           "58":self.SFP2_AR_LS_label.setStyleSheet,           	
           "59":self.SFP3_AR_LS_label.setStyleSheet,
           "60":self.SFP4_AR_LS_label.setStyleSheet,               	
###########################
           "61":self.QSFP1_AR1_PF_label.setStyleSheet,
           "62":self.QSFP1_AR2_PF_label.setStyleSheet,
           "63":self.QSFP1_AR3_PF_label.setStyleSheet,
           "64":self.QSFP1_AR4_PF_label.setStyleSheet,
           "65":self.QSFP2_AR1_PF_label.setStyleSheet,
           "66":self.QSFP2_AR2_PF_label.setStyleSheet,
           "67":self.QSFP2_AR3_PF_label.setStyleSheet,
           "68":self.QSFP2_AR4_PF_label.setStyleSheet,           	
           "69":self.SFP1_AR_PF_label.setStyleSheet,
           "70":self.SFP2_AR_PF_label.setStyleSheet,           	
           "71":self.SFP3_AR_PF_label.setStyleSheet,
    ...
    def refresh_GUI(self):
        ...
        for i in range(1,13):
            if self.link_stat(i) == 1:
                ...
                t = str(i+48)
                self.EventMethods[t]("background-color: rgb(0, 255, 0);")
                ...
                if self.ber(i) <= 1e-13:
                    ...
                    t = str(i+60)
                    self.EventMethods[t]("background-color: rgb(255, 0, 0);")
...
#                fail[i - 1].config(text='FAIL', bg='red')
            ...
            t = str((i-1)*4+2)
            self.EventMethods[t](QtGui.QApplication.translate("MainWindow", '%.3f' % self.eye_marg(i), None, QtGui.QApplication.UnicodeUTF8))
            t = str((i-1)*4+3)
            self.EventMethods[t](QtGui.QApplication.translate("MainWindow", '%.2E' % self.ber(i), None, QtGui.QApplication.UnicodeUTF8))

        
        self.list.append(self.QSFP1_AR1_LS_label)
        self.list.append(self.QSFP1_AR2_LS_label)

        self.list[0].setText(QtGui.QApplication.translate("MainWindow", "list suc......", None, QtGui.QApplication.UnicodeUTF8))
        self.list[1].setText(QtGui.QApplication.translate("MainWindow", "list suc......", None, QtGui.QApplication.UnicodeUTF8))
        self.channelMap[0][0].setText(QtGui.QApplication.translate("MainWindow", "list suc......666666", None, QtGui.QApplication.UnicodeUTF8))
#        self.channelMap[1][0].setText(QtGui.QApplication.translate("MainWindow", "list suc......666666", None, QtGui.QApplication.UnicodeUTF8))
