    ...
    def table(self):
        ...
        for i in range(1, 9):
            ...
            if i<5:
                ...
                ar[i - 1].grid(row=0, column=i-4, sticky='S', ipadx=41, pady=1)
    ...
    def data(self):
        ...
        for i in range(1, 9):
            ...
            if i<5:
                ...
                fail[i - 1] = Label(self.subFrm3, width=3, height=1, relief='solid', bd=1)
                eye[i - 1] = Label(self.subFrm3, text='%.3f' % self.eye_marg(i),
                                   bg='white', width=3, height=1)
                ber[i - 1] = Label(self.subFrm3, text='%.2E' % self.ber(i),
                                   bg='white', width=3, height=1)
            else:
                link[i - 1] = Label(self.subFrm4, width=3, height=1)
                fail[i - 1] = Label(self.subFrm4, width=3, height=1, relief='solid', bd=1)
                eye[i - 1] = Label(self.subFrm4, text='%.3f' % self.eye_marg(i),
                                   bg='white', width=3, height=1)
                ber[i - 1] = Label(self.subFrm4, text='%.2E' % self.ber(i),
                                   bg='white', width=3, height=1)
        ...
        for i in range(1, 9):
            ...
            if i<5:
                ...
                fail[v - 1] = Label(self.subFrm2, width=3, height=1, relief='solid', bd=1)
                eye[v - 1] = Label(self.subFrm2, text='%.3f' % self.eye_marg(v),
                                   bg='white', width=3, height=1)
                ber[v - 1] = Label(self.subFrm2, text='%.2E' % self.ber(v),
                                   bg='white', width=3, height=1)
